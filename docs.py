...
# documents route. whenever user clicks on the document page, this method is called
# redirect to the documents page and want to pass it the documents from the internship_table collection
@app.route('/documents', methods = ['GET'])
def return():
    return render_template('docs.html', docs = internships_table.documents)
